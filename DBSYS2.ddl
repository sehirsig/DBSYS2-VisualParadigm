CREATE TABLE Vorlesung (ID number(10) GENERATED AS IDENTITY, StudiengangKuerzel varchar2(255) NOT NULL, Name2 varchar2(255), Ects number(10) NOT NULL, Sws number(10) NOT NULL, PRIMARY KEY (ID));
