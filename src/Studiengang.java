...
public class Studiengang {
	...
	public static Studiengang loadStudiengangByORMID(String kuerzel) throws PersistentException {
		try {
			PersistentSession session = DBSYS2PersistentManager.instance().getSession();
	...
	public boolean save() throws PersistentException {
		try {
			DBSYS2PersistentManager.instance().saveObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean delete() throws PersistentException {
		try {
			DBSYS2PersistentManager.instance().deleteObject(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean refresh() throws PersistentException {
		try {
			DBSYS2PersistentManager.instance().getSession().refresh(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public boolean evict() throws PersistentException {
		try {
			DBSYS2PersistentManager.instance().getSession().evict(this);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
